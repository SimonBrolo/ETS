  ...
  return (
    <div className="erta-state-scroll">
      ...
      <div className="erta-state-inner">
        ...
        {/* Expert fallback */}
        <div className="erta-expert-fallback">
          ...
          <button type="button" className="erta-expert-fallback-btn" onClick={onExpert}>
...
const ExpertChatScreen = ({ req, typing, onBack, onSend, onAttach }) => {
  ...
  return (
    <div className="erta-state-scroll erta-chat-scroll">
      <div className="erta-result-banner">
        <div className="erta-result-banner-inner">
          <button type="button" className="erta-expert-backlink" onClick={onBack}>
            <IconChevL size={14} stroke={2.5} /> Zurück zum Ergebnis
          </button>
...
const ExpertContactView = ({ req, onCancel, onStart }) => {
  ...
  return (
    <div className="erta-state-scroll">
      <div className="erta-result-banner">
        <div className="erta-result-banner-inner">
          <button type="button" className="erta-expert-backlink" onClick={onCancel}>
            <IconChevL size={14} stroke={2.5} /> Zurück zum Ergebnis
          </button>
